...
export default function ImpressiveTemplate({
  ...
  //- khoi tao ten cv bang gia tri resumeName hien tai truyen tu db
  const [resumeName, setResumeName] = useState(initialResumeName || "CV Impressive");
  ...
  return (
    <>
      <Form {...form}>
        <form
          className={cn(
            "w-full max-w-[210mm] mx-auto min-h-screen pb-2 bg-background text-foreground",
            isView && "pointer-events-none select-none",
          )}
        >
          <div className="container mx-auto py-8">
            {/*- Bọc toàn bộ CV vào một khung nền lớn */}
            <div className="bg-card border border-border shadow-xl rounded-lg p-6 md:p-8 text-card-foreground">
              <div className="grid grid-cols-4 sm:grid-cols-12 gap-8">
                {/*- Cột trái: Sidebar */}
                <div className="col-span-4 sm:col-span-4 border-b sm:border-b-0 sm:border-r border-border pb-6 sm:pb-0 pr-0 sm:pr-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <Textarea
                          ...
                          className={cn(
                            editableBase,
                            "text-foreground resize-none min-h-[100px] border-none focus-visible:ring-0 px-2 w-full",
                          )}
                        />
                      )}
                    />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <Textarea
                              ...
                              className={cn(
                                editableBase,
                                "text-muted-foreground min-h-[60px] resize-none mt-2 w-full border-none focus-visible:ring-0 px-2 shadow-none",
                              )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <Textarea
                              ...
                              className={cn(
                                editableBase,
                                "text-muted-foreground min-h-[60px] resize-none w-full border-none focus-visible:ring-0 px-2 shadow-none",
                              )}
